...
interface ToolbarProps {
  initialData: Doc<"templates">;
  editorFont?: string;
  preview?: boolean;
}

export const ToolbarTemplate = ({ initialData, preview, editorFont }: ToolbarProps) => {
  ...
  const removeIcon = useMutation(api.templates.removeIcon);
